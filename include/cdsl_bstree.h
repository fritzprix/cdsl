...
#define cdsl_bstreeSerialize(root, serializer, cb)     tree_serialize((base_treeRoot_t*) root, (cdsl_serializer_t*) serializer, cb, NULL)
#define cdsl_bstreeDeserialize(root, desrl, alloc)     tree_deserialize((base_treeRoot_t*) root,(cdsl_deserializer_t*) desrl, alloc, NULL)
